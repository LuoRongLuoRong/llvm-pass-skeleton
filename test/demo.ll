; ModuleID = '../test/demo.cpp'
source_filename = "../test/demo.cpp"
...
@.str.1 = private unnamed_addr constant [6 x i8] c" is 6\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_demo.cpp, i8* null }]

; Function Attrs: noinline uwtable
define internal void @__cxx_global_var_init() #0 section ".text.startup" !dbg !854 {
entry:
  call void @_ZNSt8ios_base4InitC1Ev(%"class.std::ios_base::Init"* nonnull align 1 dereferenceable(1) @_ZStL8__ioinit), !dbg !855
  %0 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::ios_base::Init"*)* @_ZNSt8ios_base4InitD1Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::ios_base::Init", %"class.std::ios_base::Init"* @_ZStL8__ioinit, i32 0, i32 0), i8* @__dso_handle) #3, !dbg !857
  ret void, !dbg !855
}
...
define i32 @main() #4 !dbg !858 {
entry:
  %retval = alloca i32, align 4
  %i1 = alloca i32, align 4
  %i2 = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0)), !dbg !859
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0)), !dbg !860
  call void @llvm.dbg.declare(metadata i32* %i1, metadata !861, metadata !DIExpression()), !dbg !862
  store i32 2, i32* %i1, align 4, !dbg !862
  %0 = load i32, i32* %i1, align 4, !dbg !863
  %add = add nsw i32 %0, 5, !dbg !864
  store i32 %add, i32* %i1, align 4, !dbg !865
  %call2 = call nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* nonnull align 8 dereferenceable(16) @_ZSt3cin, i32* nonnull align 4 dereferenceable(4) %i1), !dbg !866
  call void @llvm.dbg.declare(metadata i32* %i2, metadata !867, metadata !DIExpression()), !dbg !868
  %1 = load i32, i32* %i1, align 4, !dbg !869
  store i32 %1, i32* %i2, align 4, !dbg !868
  %2 = load i32, i32* %i1, align 4, !dbg !870
  %add3 = add nsw i32 %2, 5, !dbg !871
  store i32 %add3, i32* %i1, align 4, !dbg !872
  %3 = load i32, i32* %i1, align 4, !dbg !873
  %add4 = add nsw i32 %3, 9, !dbg !874
  store i32 %add4, i32* %i2, align 4, !dbg !875
  %4 = load i32, i32* %i1, align 4, !dbg !876
  %call5 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 %4), !dbg !877
  %call6 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %call5, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0)), !dbg !878
  %call7 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %call6, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !dbg !879
  ret i32 0, !dbg !880
}
...
declare nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8), i32) #1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_demo.cpp() #0 section ".text.startup" !dbg !881 {
entry:
  call void @__cxx_global_var_init(), !dbg !883
  ret void
}
...
!llvm.dbg.cu = !{!7}
!llvm.module.flags = !{!847, !848, !849, !850, !851, !852}
!llvm.ident = !{!853}
...
!8 = !DIFile(filename: "../test/demo.cpp", directory: "/home/fdse/luorong/LLVM/llvm-pass-skeleton/build")
!9 = !{}
!10 = !{!0}
...
!852 = !{i32 7, !"frame-pointer", i32 2}
!853 = !{!"clang version 13.0.0"}
!854 = distinct !DISubprogram(name: "__cxx_global_var_init", scope: !8, file: !8, type: !456, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !7, retainedNodes: !9)
!855 = !DILocation(line: 74, column: 25, scope: !856)
!856 = !DILexicalBlockFile(scope: !854, file: !3, discriminator: 0)
!857 = !DILocation(line: 0, scope: !854)
!858 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 9, type: !539, scopeLine: 9, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !9)
!859 = !DILocation(line: 23, column: 5, scope: !858)
!860 = !DILocation(line: 26, column: 5, scope: !858)
!861 = !DILocalVariable(name: "i1", scope: !858, file: !8, line: 28, type: !20)
!862 = !DILocation(line: 28, column: 9, scope: !858)
!863 = !DILocation(line: 29, column: 10, scope: !858)
!864 = !DILocation(line: 29, column: 13, scope: !858)
!865 = !DILocation(line: 29, column: 8, scope: !858)
!866 = !DILocation(line: 30, column: 14, scope: !858)
!867 = !DILocalVariable(name: "i2", scope: !858, file: !8, line: 31, type: !20)
!868 = !DILocation(line: 31, column: 9, scope: !858)
!869 = !DILocation(line: 31, column: 14, scope: !858)
!870 = !DILocation(line: 32, column: 10, scope: !858)
!871 = !DILocation(line: 32, column: 13, scope: !858)
!872 = !DILocation(line: 32, column: 8, scope: !858)
!873 = !DILocation(line: 33, column: 10, scope: !858)
!874 = !DILocation(line: 33, column: 13, scope: !858)
!875 = !DILocation(line: 33, column: 8, scope: !858)
!876 = !DILocation(line: 34, column: 18, scope: !858)
!877 = !DILocation(line: 34, column: 15, scope: !858)
!878 = !DILocation(line: 34, column: 21, scope: !858)
!879 = !DILocation(line: 34, column: 31, scope: !858)
!880 = !DILocation(line: 58, column: 5, scope: !858)
!881 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_demo.cpp", scope: !8, file: !8, type: !882, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !7, retainedNodes: !9)
!882 = !DISubroutineType(types: !9)
